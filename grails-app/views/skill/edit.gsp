...
<%@ page import="avliscraftgrails.Skill" %>
<html>
    <head>
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="recipes"><g:message code="skill.recipes.label" default="Recipes" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: skillInstance, field: 'recipes', 'errors')}">
                                    
<ul>
<g:each in="${skillInstance?.recipes?}" var="r">
    <li><g:link controller="recipe" action="show" id="${r.id}">${r?.encodeAsHTML()}</g:link></li>
</g:each>
</ul>
<g:link controller="recipe" action="create" params="['skill.id': skillInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'recipe.label', default: 'Recipe')])}</g:link>

            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.recipes.label" default="Recipes" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.chars.label" default="Chars" /></td>

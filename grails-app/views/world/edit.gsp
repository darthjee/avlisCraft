                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="name"><g:message code="world.name.label" default="Name" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: worldInstance, field: 'name', 'errors')}">
                                    <g:textField name="name" value="${worldInstance?.name}" />
                                </td>
                            </tr>
